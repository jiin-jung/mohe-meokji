...
| **이름** | **역할** | **담당 업무** |
|:--------:|:--------:|:-------------|
| <a href="https://github.com/jiin-jung"><img src="https://github.com/jiin-jung.png" width="70px"/><br/><sub><b>정지인</b></sub></a> | FS | 백엔드 핵심 비즈니스 로직 구현, RESTful API 설계 및 DB 구조 최적화, 프론트엔드 UI/UX 구현 및 API 연동 |
